    ...
    if type == 'retrait':
        ...
        if liste[2] == 'Positif':
            ...
            if (int(liste[3]) - int(liste[1])) >= val:
                ...
                ligne_bien = L[0] + "." + nv_solde + "." + "Negatif" + "." + L[3]
                bien.write(ligne_bien)
                ligne_histo = L[0] + "." + "retrait" + "." + str(
                    val) + "." + resultat + "." + "Negatif"
                histo.write(ligne_histo)
